    ...
    return(
      <div className='admin-grid-wrapper'>
        ...
        <div className='admin-grid__save-button--wrapper'>
          {  categoriesList && categoriesList.find(category=>category.get('id')==currentCategory) &&  <button className='admin-grid__save-button' onClick={this.saveLayouts(newItemsSettings,currentCategory)}>
